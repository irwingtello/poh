...
contract Domains is ERC721URIStorage, AccessControl {
    ...
    require(success, "Failed to withdraw Filecoin");
    } 
    ...
    function register(string calldata _name,string calldata _tokenURI) public payable onlyRole(APP_ROLE) {
      ...
      require(msg.value >= _price, "Not enough Filecoin paid");
   ...
   function helpRegister(string calldata _name,string calldata _tokenURI) public  onlyRole(APP_ROLE) {
